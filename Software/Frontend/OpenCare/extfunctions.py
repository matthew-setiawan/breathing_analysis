...
def getsensors(model):
      if model=="1.0 Temperature Scanner":
            return ["temperaturereading","accelerometerreading","co2reading","heartratereading","knittedcoilarea1","knittedcoilarea2","temperaturereadingprediction","accelerometerreadingprediction","co2readingprediction","heartratereadingprediction"]
      return []
...
def aiquery(query):
      ...
      openai.api_key = "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"
